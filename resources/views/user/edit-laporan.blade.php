                        ...
                        <form id="formulir-register" class="bootstrap-form-with-validation" method="post" enctype="multipart/form-data" action ="{{ route('update.laporan') }}">
                            ...
                            <div class="row row-email">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 login-input">
                                    <input value="{{ $laporan->title }}" class="form-control" type="text" placeholder="Judul" name="title">
                                </div>
                            </div> 
                            ...
                            <div class="row row-lokasi">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 login-input">
                                    <input value="{{ $laporan->location }}" class="form-control" type="text" placeholder="Lokasi" name="location">
                                </div>
                            </div>
                            <div class="row row-deskripsi">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 login-input">
                                    <textarea class="form-control" placeholder="Deskripsi" name="content">{{ $laporan->content }}</textarea>
                                </div>
                            </div>
