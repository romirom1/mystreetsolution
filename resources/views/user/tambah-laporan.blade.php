                        ...
                        <form id="formulir-register" class="bootstrap-form-with-validation" method="post" enctype="multipart/form-data" action ="{{ route('post.report') }}">
                            ...
                            <div class="row row-email{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 login-input">
                                    <input class="form-control" type="text" placeholder="Judul" name="title" value="{{ old('title') }}" required autofocus>
                                    @if ($errors->has('title'))
                            ...
                            <div class="row row-lokasi{{ $errors->has('categories_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 login-input">
                                <select  name="categories_id" class="form-control select-option" required autofocus>
                            ...
                            <div class="row row-lokasi{{ $errors->has('location') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 login-button">
                                    <button class="btn btn-primary login-button" style="margin-top:5px" onClick=initMap() type="button">Dapatkan Lokasi Saat Ini</button>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 login-button">
                                    <button class="btn btn-primary login-button" style="margin-top:5px" onClick=getLocation() type="button">Cari Lokasi</button>
                                </div>
                            </div>
                            <div class="row row-deskripsi{{ $errors->has('content') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 login-input">
                                    <textarea class="form-control" placeholder="Deskripsi" name="content" required autofocus></textarea>
                                </div>
                            ...
                            <div class="row row-foto{{ $errors->has('photo') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 foto-input">
                                    <input type="file" name="photo" accept="image/*" required autofocus>
                                    @if ($errors->has('title'))
                                    <span class="help-block">
                                        <strong>error : masukkan gambar</strong>
                                    </span>
                                @endif
                                </div>
                            </div>
