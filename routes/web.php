...
Route::post('/tambah-komentar','KomentarController@tambah')->name('tambah.komentar');
...
Route::prefix('admin')->group(function(){
	...
	Route::post('/konfirmasi','AdminController@konfirmasi')->name('admin.konfirmasi.laporan.submit');
	Route::get('kelola-laporan','AdminController@kelola')->name('admin.kelola.laporan');
	Route::post('kelola-laporane','AdminController@kelolae')->name('admin.kelola.laporan.submit');
	Route::get('laporan-masuk','AdminController@komentar')->name('admin.komentar');
	Route::post('laporan-masuke','AdminController@komentare')->name('admin.komentar.submit');
	Route::get('kelola-member','AdminController@member')->name('admin.kelola.member');
	Route::post('kelola-membere','AdminController@membere')->name('admin.kelola.member.submit');
});
